        ...
        >
          <header className="text-center flex flex-col items-center">
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-neutral-950">
              Sign In To Agent<span className="text-primary">Tube</span>
            </h1>
          </header>
          ...
          <SignIn.Action
            submit
            className="relative w-full rounded-md  bg-primary py-1.5 text-sm font-medium text-white shadow-[0_1px_1px_0_rgba(255,255,255,0.1)_inset,0_1px_2.5px_0_rgba(0,0,210,0.36)] outline-none ring-1 ring-inset ring-blue-600 before:absolute before:inset-0 before:rounded-md before:bg-white/10 before:opacity-0 hover:before:opacity-100 focus-visible:outline-offset-2 focus-visible:outline-blue-600 active:bg-blue-600 active:text-white/60 active:before:opacity-0"
          >
            Sign In
          </SignIn.Action>
